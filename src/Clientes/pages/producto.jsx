      ...
      <main className='ola'>
        <div className='imagen'>
          <img
            ...
            width="550"
            alt={producto.nombre_producto}  // Es importante agregar un 'alt' para accesibilidad
          />
          <div>
            <ul className="nav nav-underline">
              <li className="nav-item">
                <a className="nav-link" aria-current="page" onClick={() => setdescripcion(false)}>Caracteristicas</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" onClick={() => setdescripcion(true)}>Descripcion</a>
              </li>
            </ul>
            {descripcion ? (
